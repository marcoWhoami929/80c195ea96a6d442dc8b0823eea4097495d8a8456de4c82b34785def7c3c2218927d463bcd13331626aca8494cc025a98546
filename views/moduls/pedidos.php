                                                                ...
                                                                <div class="table-filter filterParams">
                                                                    <div class="row">
                                                                        ...
                                                                        <div class="col-lg-12 col-md-12 col-sm-12">
                                                                            <div class="filter-group" style="display:none" id="btnRealizarPedidos">
                                                                            ...
                                                                            <div class="filter-group" style="display:none" id="btnListaSucursales">
                                                                                ...
                                                                                <select class="form-control" id="sucursal" onchange="listaPedidos();">
                                                                            ...
                                                                            <div class="filter-group">
                                                                                ...
                                                                                <select class="form-control" id="anio" onchange="listaPedidos();">
                                                                            ...
                                                                            <div class="filter-group">
                                                                                <span>Mostrar</span>
                                                                                <select class="form-control" id="per_page" onchange="listaPedidos();">
                                                                            ...
                                                                            <div class="filter-group">
                                                                                <span>Estatus</span>
                                                                                <select class="form-control" id="estatus" onchange="listaPedidos();">
                                                                            ...
                                                                            <div class="filter-group">
                                                                                <span>Prioridad</span>
                                                                                <select class="form-control" id="prioridad" onchange="listaPedidos();">
                                                                                    <option value="">Todos</option>
                                                                            ...
                                                                            <div class="filter-group">
                                                                                ...
                                                                                <select class="form-control" id="campoOrden" onchange="listaPedidos();">
                                                                            ...
                                                                            <div class="filter-group">
                                                                                <span>Orden</span>
                                                                                <select class="form-control" id="orden" onchange="listaPedidos();">
