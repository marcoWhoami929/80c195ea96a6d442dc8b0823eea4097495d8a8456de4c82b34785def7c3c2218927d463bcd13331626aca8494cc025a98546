                            ...
                            <div class="row align-items-center">
                                <div class="col-md-8">
                                    <div class="page-header-title">
                                        <h5 class="m-b-10">Backorder Pedidos</h5>
                                        <p class="m-b-0"></p>
                                                                    ...
                                                                    <div class="row">
                                                                        ...
                                                                        <div class="col-lg-12 col-md-12 col-sm-12">
                                                                            ...
                                                                            <div class="filter-group" style="display:none" id="btnListaSucursales">
                                                                                ...
                                                                                <select class="form-control" id="sucursal" onchange="listaPedidosFaltantes();">
                                                                            ...
                                                                            <div class="filter-group">
                                                                                ...
                                                                                <select class="form-control" id="anio" onchange="listaPedidosFaltantes();">
                                                                            ...
                                                                            <div class="filter-group">
                                                                                <span>Mostrar</span>
                                                                                <select class="form-control" id="per_page" onchange="listaPedidosFaltantes();">
                                                                            ...
                                                                            <div class="filter-group">
                                                                                <span>Prioridad</span>
                                                                                <select class="form-control" id="prioridad" onchange="listaPedidosFaltantes();">
                                                                            ...
                                                                            <div class="filter-group">
                                                                                ...
                                                                                <select class="form-control" id="campoOrden" onchange="listaPedidosFaltantes();">
                                                                            ...
                                                                            <div class="filter-group">
                                                                                <span>Orden</span>
                                                                                <select class="form-control" id="orden" onchange="listaPedidosFaltantes();">
