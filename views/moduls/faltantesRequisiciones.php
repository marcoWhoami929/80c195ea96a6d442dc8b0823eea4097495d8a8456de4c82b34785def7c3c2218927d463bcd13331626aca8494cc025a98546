                            ...
                            <div class="row align-items-center">
                                <div class="col-md-8">
                                    <div class="page-header-title">
                                        <h5 class="m-b-10">Requisiciones Con Material Pendiente</h5>
                                        <p class="m-b-0"></p>
                                ...
                                <div class="col-md-4">
                                    <ul class="breadcrumb">
                                        ...
                                        <li class="breadcrumb-item"><a href="#!">Faltantes Requisiciones</a>
                                        </li>
                                    </ul>
                                </div>
                            </div>
                                                            ...
                                                            <div class="table-wrapper">
                                                                ...
                                                                <div class="table-title" style="margin-top:-80px">
                                                                    <div class="row">
                                                                        ...
                                                                        <div class="col-lg-2 col-md-2 col-sm-2">
                                                                            <button type="button" class="btn nestable-info" onclick=""><i class="fa fa-eye"></i>En Revisión</button>
                                                                    ...
                                                                    <div class="row">
                                                                        ...
                                                                        <div class="col-lg-12 col-md-12 col-sm-12">
                                                                            ...
                                                                            <div class="filter-group" style="display:none" id="btnListaSucursales">
                                                                                ...
                                                                                <select class="form-control" id="sucursal" onchange="listaRequisicionesFaltantes();">
                                                                            ...
                                                                            <div class="filter-group">
                                                                                ...
                                                                                <select class="form-control" id="anio" onchange="listaRequisicionesFaltantes();">
                                                                            ...
                                                                            <div class="filter-group">
                                                                                <span>Mostrar</span>
                                                                                <select class="form-control" id="per_page" onchange="listaRequisicionesFaltantes();">
                                                                            ...
                                                                            <div class="filter-group">
                                                                                <span>Estatus</span>
                                                                                <select class="form-control" id="estatus" onchange="listaRequisicionesFaltantes();">
                                                                                    <option value="4">Entregado</option>
                                                                                </select>
                                                                            </div>
                                                                            <div class="filter-group">
                                                                                <span>Prioridad</span>
                                                                                <select class="form-control" id="prioridad" onchange="listaRequisicionesFaltantes();">
                                                                            ...
                                                                            <div class="filter-group">
                                                                                ...
                                                                                <select class="form-control" id="campoOrden" onchange="listaRequisicionesFaltantes();">
                                                                            ...
                                                                            <div class="filter-group">
                                                                                <span>Orden</span>
                                                                                <select class="form-control" id="orden" onchange="listaRequisicionesFaltantes();">
