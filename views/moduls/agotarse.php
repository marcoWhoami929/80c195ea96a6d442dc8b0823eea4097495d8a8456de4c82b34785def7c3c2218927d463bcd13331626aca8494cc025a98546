                                                        ...
                                                        <div class="card-block table-border-style">
                                                            <div class="table-wrapper">
                                                                <div class="table-title">
                                                                    <div class="container col-lg-12 col-md-12 col-sm-12" style="margin-top:-2px">
                                                                        <div class="row">
                                                                            <div class="col-lg-3 col-md-3 col-sm-3">
                                                                                <h3>Productos por Agotarse</h3>
                                                                            </div>
                                                                            <div class="col-lg-3 col-md-3 col-sm-3">
                                                                                Unidades Faltantes:<h3 id="totalPorAgotarse"></h3>
                                                                            </div>
                                                                            <div class="col-lg-3 col-md-3 col-sm-3">
                                                                                Monto Faltante:<h3 id="montoPorAgotarse"></h3>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                ...
                                                                <div class="table-filter filterParams2" style="margin-top:2px">
                                                                    <div class="row">
                                                                        ...
                                                                        <div class="filter-group">
                                                                            ...
                                                                            <select class="form-control selectorCategoria" name="categoria" id="categoria" onchange="productosPorAgotarse();">
                                                                                <option value=""></option>
                                                                                <?php
                                                                        ...
                                                                        <div class="filter-group">
                                                                            ...
                                                                            <select class="form-control" name="clasificacion" id="clasificacion" onchange="productosPorAgotarse();">
                                                                        ...
                                                                        <div class="filter-group">
                                                                            <label>Almacen:</label>
                                                                            <select class="form-control" name="almacen" id="almacen" onchange="productosPorAgotarse();">
                                                                                <?php
                                                                        ...
                                                                        <div class="filter-group">
                                                                            <span>Mostrar</span>
                                                                            <select class="form-control" id="per_page" onchange="productosPorAgotarse();">
                                                                        ...
                                                                        <div class="filter-group">
                                                                            <span>Estatus</span>
                                                                            <select class="form-control" id="estatus" onchange="productosPorAgotarse();">
                                                                        ...
                                                                        <div class="filter-group">
                                                                            ...
                                                                            <select class="form-control" id="campoOrden" onchange="productosPorAgotarse();">
                                                                        ...
                                                                        <div class="filter-group">
                                                                            <span>Orden</span>
                                                                            <select class="form-control" id="orden" onchange="productosPorAgotarse();">
                    ...
                    <div class="form-group">
                        ...
                        <div class="row">
                            <div class="col-lg-9 col-md-9 col-sm-9">
                                ...
                                <input type="hidden" class="form-control" id="clasificacionVenta" value="cargarListaProductosAgotarse">
                                <input type="hidden" class="form-control" id="clasificacionVenta2" value="cargarListaProductosAgotarse">
                            </div>
