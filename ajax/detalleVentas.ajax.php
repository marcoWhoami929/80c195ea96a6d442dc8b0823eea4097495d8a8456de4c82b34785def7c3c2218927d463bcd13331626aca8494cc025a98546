                ...
                <tbody>
                    ...
                    ?>
                        <tr>
                            ...
                            <td style="text-align:left;color:#00BCD4;font-weight:bold"><?= $row['CSERIEDOCUMENTO']; ?></td>
                            <td style="text-align:left;color:#00BCD4;font-weight:bold"><?= (int)$row['CFOLIO'] ?></td>
                ...
                <tbody>
                    ...
                    ?>
                        <tr>
                            ...
                            <td style="text-align:left;color:#00BCD4;font-weight:bold"><?= $row['CSERIEDOCUMENTO']; ?></td>
                            <td style="text-align:left;color:#00BCD4;font-weight:bold"><?= (int)$row['CFOLIO'] ?></td>
                            <td style="text-align:left;color:#00BCD4;font-weight:bold"><?= $row['TotalUnidades'] ?></td>
                            <td style="font-weight:bold;text-align:right">$<?= number_format($row['Total'], 2) ?></td>
