            ...
            <tbody>
                ...
                ?>
                    <tr>
                        ...
                        <td>
                            <button type="button" class="btn nestable-info" onclick="obtenerDatosConcepto(<?= $row['CIDPARAM']; ?>,'PINTURAS')"><i class="fa fa-edit"></i></button>
                            <button type="button" class="btn nestable-danger" onclick="eliminarConcepto(<?= $row['CIDPARAM']; ?>,'PINTURAS')"><i class="fa fa-trash"></i></button>
                        </td>
                    </tr>
                <?php
                    $finales++;
            ...
            <tbody>
                ...
                ?>
                    <tr>
                        ...
                        <td> <?= $row['CCANALCOMERCIAL'] ?></td>
                        <td>
                            <button type="button" class="btn nestable-info" onclick="obtenerDatosConcepto(<?= $row['CIDPARAM']; ?>,'FLEX')"><i class="fa fa-edit"></i></button>
                            <button type="button" class="btn nestable-danger" onclick="eliminarConcepto(<?= $row['CIDPARAM']; ?>,'FLEX')"><i class="fa fa-trash"></i></button>
                        </td>
                    </tr>
                <?php
                    $finales++;
